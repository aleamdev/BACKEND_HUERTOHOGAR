...
import com.eva3.huertohogar.dto.RefreshTokenRequest;   // <-- IMPORT NUEVO
...
import jakarta.validation.Valid;                        // <-- IMPORT NUEVO
...
@CrossOrigin(origins = "*") // por si frontend está en otro puerto
